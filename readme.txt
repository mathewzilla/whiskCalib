...
================================
-calibView 
-run_calibView.sh (shell script for temporarily setting environment variables and 
                   executing the application)
   -to run the shell script, type
   
       ./run_calibView.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v85, run the shell script as:
       ...
       ./run_calibView.sh /mathworks/home/application/v85
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_calibView.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux x86-64 systems:
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_calibView.sh 
